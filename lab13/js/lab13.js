...
//this expcts to have input fields with ids num0, text0, num1, text1, etc
...
document.getElementById("submit").addEventListener("click", function() {
    ...
    if (Object.keys(factorObj).length === 0) {
        reportError("You must provide at least one factors and text");
        return;
    }
    // clear eror if there is one
    outputEl.innerHTML = "";
